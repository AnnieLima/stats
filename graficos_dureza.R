...
dureza <- read.table(
  "C:/Users/Annie de Lima/Downloads/Estatística/stat_debs/dureza.txt",
  header = T)
names <- dureza$especie
value <- dureza$radial
...
data %>%
  ...
  ggtitle("Dureza - Face Radial") +
  ylab("Carga (kgf)") + xlab("Espécies") + coord_flip () 
...
data %>%
  ...
  ggtitle("Dureza - Face Tangencial") +
  ylab("Carga (kgf)")  + xlab("Espécies") + coord_flip ()
